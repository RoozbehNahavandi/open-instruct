...
def main(args: Args, tc: TokenizerConfig, model_config: ModelConfig):
    ...
    pg = None
    bundles = [{"GPU": actor_num_gpus, "CPU": 16} for actor_num_gpus in args.actor_num_gpus_per_node]
    print(f'bundles={bundles}, actor_num_gpus_per_node={args.actor_num_gpus_per_node}')
